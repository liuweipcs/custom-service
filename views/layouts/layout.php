...
<html lang="zh-CN">
	...
	<head>
    <title><?php echo isset($this->title)?$this->title:'易佰网络客服系统';?></title>
		<meta charset="utf-8">
    	...
    	<script type="text/javascript" charset="utf-8"  src="<?php echo yii\helpers\Url::base(true);?>/js/UEditor/ueditor.config.js"></script>
    	<script type="text/javascript" charset="utf-8"  src="<?php echo yii\helpers\Url::base(true);?>/js/UEditor/ueditor.all.min.js"></script>
    	<script type="text/javascript" charset="utf-8"  src="<?php echo yii\helpers\Url::base(true);?>/js/UEditor/lang/zh-cn/zh-cn.js"></script>
