...
<div class="popup-wrapper">
    ...
    $form = ActiveForm::begin([
        ...
        'action' => Url::toRoute(['/customer/customer/contact']),
        'method' => 'post',
    ]);
    ?>
    <div class="popup-body">
        <table id="addMailFilterManage">
            <tr>
                <td class="col1">平台：</td>
                <td colspan="2">
                    <input type="text" id="plat_f" name="platform_code" class="form-control" readonly="readonly" value="<?php echo $info['platform_code']; ?>">
                </td>
            </tr>
            <tr>
            ...
            <tr class="b1">
                <td class="col1">店铺：</td>
                <td colspan="2">
                    <input type="text" name="account_name" class="form-control" readonly="readonly" value="<?php echo $info['account_name']; ?>">
                </td>
            </tr>
            <tr class="b1">
                <td class="col1">客户ID：</td>
                <td colspan="2">
                    <input type="text" name="buyer_id" class="form-control" readonly="readonly" value="<?php echo $info['buyer_id']; ?>">
                </td>
            </tr>
            <tr class="a1">
            ...
            <tr class="a1">
                ...
                <td colspan="2">
                    <input type="text" name="buyer_email" class="form-control" readonly="readonly" value="<?php echo $info['buyer_email']; ?>">
                </td>
            </tr>
            <tr class="a1">
                ...
                <td colspan="2">
                    ...
                    <div class="panel-body mail_template_area">
                        <ul class="list-inline">
                            <?php
                            $mailTemplates = MailTemplate::getCustomerDataAsArray($info['platform_code']);
