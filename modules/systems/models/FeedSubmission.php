 ...
 */
class FeedSubmission extends SystemsModel
{   
    ...
    {
        return [
            [['after_sale_id', 'account_name', 'request_id', 'feed_type', 'submitted_date', 'feed_submission_id', 'feed_processing_status'], 'required'],
            [['submitted_date'], 'safe'],
            [['old_account_id'], 'integer'],
            [['after_sale_id', 'request_id', 'feed_type', 'feed_submission_id', 'account_name'], 'string', 'max' => 50],
