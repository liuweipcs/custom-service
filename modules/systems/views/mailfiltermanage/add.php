...
<div class="popup-wrapper">
    ...
    $form = ActiveForm::begin([
        ...
        'action' => Url::toRoute(['/systems/mailfiltermanage/add']),
        'method' => 'post',
    ]);
    ?>
    <div class="popup-body">
        <table id="addMailFilterManage">
            ...
            <tr>
                ...
                <td colspan="2">
                    <table id="addMailFilterRule">
                        ...
                        <tbody>
                        <tr id="hideMailFilterRule" data-startindex="3">
                            <td class="col1">
                        ...
                        <tr>
                            <td class="col1">
                                <?php if (!empty($ruleTypeList)) { ?>
                                    ...
                                    <select name="rule_type[<?php echo $startIndex; ?>]" class="form-control">
                                        <?php foreach ($ruleTypeList as $key => $value) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($key == MailFilterRule::RULE_TYPE_SEND_CONTAIN) {
                                                echo "selected";
                            ...
                            <td>
                                <input type="text" name="rule_value[<?php echo $startIndex; ?>]" class="form-control">
                            </td>
                            <td>
                                <span class="glyphicon glyphicon-remove"></span>
                            </td>
                        ...
                        <tr>
                            <td class="col1">
                                <?php if (!empty($ruleTypeList)) { ?>
                                    ...
                                    <select name="rule_type[<?php echo $startIndex; ?>]" class="form-control">
                                        <?php foreach ($ruleTypeList as $key => $value) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($key == MailFilterRule::RULE_TYPE_RECEIVE_CONTAIN) {
                                                echo "selected";
                                            } ?>><?php echo $value; ?></option>
                                        <?php } ?>
                                    </select>
                        ...
                        <tr>
                            <td class="col1">
                                <?php if (!empty($ruleTypeList)) { ?>
                                    ...
                                    <select name="rule_type[<?php echo $startIndex; ?>]" class="form-control">
                                        <?php foreach ($ruleTypeList as $key => $value) { ?>
                                            <option value="<?php echo $key; ?>" <?php if ($key == MailFilterRule::RULE_TYPE_SUBJECT_CONTAIN) {
                                                echo "selected";
                                            } ?>><?php echo $value; ?></option>
                                        <?php } ?>
                                    </select>
            ...
            <tr>
                ...
                <td class="col2">
                    <input type="checkbox" id="isMoveSite"> 邮件移动到站点
                </td>
                <td id="siteList">
            ...
            <tr>
                <td class="col1">&nbsp;</td>
                <td class="col2">
                    <input type="checkbox" id="isTypeMark"> 邮件类型标记为
                </td>
                <td id="typeList">
            ...
            <tr>
                <td class="col1">&nbsp;</td>
                <td colspan="2">
                    <input type="checkbox" id="isMarkRead" name="mark_read" value="1"> 邮件标记为已读
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
