...
<div class="popup-wrapper">
    ...
    $form = ActiveForm::begin([
        'id' => 'updExtendTimeRuleForm',
        'action' => Url::toRoute(['/systems/extendtimerule/edit']),
        'method' => 'post',
    ]);
    ?>
    <div class="popup-body">
        <table id="addExtendTimeRule">
            ...
            <tr>
                ...
                <td><input type="text" name="extend_day" class="form-control" value="<?php echo $info['extend_day']; ?>"></td>
            </tr>
            <tr>
                <td class="col1">状态：</td>
                <td>
