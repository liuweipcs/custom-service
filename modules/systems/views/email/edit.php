...
<div class="popup-wrapper">
    ...
    <div class="popup-body">
        ...
        <div class="row"> 
            <div class="col-sm-12">
                 <?php //echo $form->field($model, 'ssl')->inline()->radioList(Email::getStatusList(), ['value' => Email::STATUS_START]);?>
            </div>
        </div>

        <div class="row">
            <div class="col-sm-12">
                <?php echo $form->field($model, 'is_amazon_send')->inline()->radioList(['1' => '是', '0' => '否 【此项设置仅对沃尔玛平台设置有效】']); ?>
            </div>
        </div>
        
        <div class="row"> 
            <div class="col-sm-12">
                <?php echo $form->field($model, 'is_encrypt')->inline()->radioList(['1' => '是', '0' => '否']); ?>
            </div>
        </div>
