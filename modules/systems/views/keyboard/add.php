    ...
    <div class="popup-body">
         <div class="row">
            ...
            <?php }?>
             ...
             <div class="col-sm-6">
                 <?php echo $form->field($model, 'tag_id')->dropdownList([''=>'请选择标签'], ['encodeSpaces' => true]);?>
                 <input type="hidden" id="keyboard-tag_name" name="Keyboard[tag_name]">
             </div>
        ...
        <div class="row">
            ...
            <input type="hidden" id="keyboard-key_code" class="form-control" name="Keyboard[key_code]">
            <input type="hidden" id="keyboard-key_basic" class="form-control" name="Keyboard[key_basic]">
        </div>
          <!--
          <div class="row">
