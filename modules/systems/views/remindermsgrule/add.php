...
<div class="popup-wrapper">
    ...
    $form = ActiveForm::begin([
        'id' => 'addReminderMsgRuleForm',
        'action' => Url::toRoute(['/systems/remindermsgrule/add']),
        'method' => 'post',
    ]);
    ?>
    <div class="popup-body">
        <table id="addReminderMsgRule">
            ...
            <tr>
                ...
                <td>
                    同一个买家在
                    <input type="text" name="buyer_once_time" value="0" class="form-control" style="display:inline-block;width:auto;">
                    小时内只催付一次
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <br>
                    <textarea name="not_reminder_buyer" rows="7" class="form-control"></textarea>
                </td>
            </tr>
            <tr>
