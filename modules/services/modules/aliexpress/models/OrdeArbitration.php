...
class OrdeArbitration
{
     ...
     * @return  bool
     */
    public function getOrdeArbitration($data)
    {
   ...
   public function sendData($data)
    {
        //实例化这个类
        $orderObj = new WhereOrdeArbitration();
        //构造参数
        ...
        $response_s = $response_s->putOtherTextParam('reason', $data['reason']);//纠纷原因
        $response_s = $response_s->putOtherTextParam('content', $data['description']);//卖家提交仲裁描述
        //引入发送类
