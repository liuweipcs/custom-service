...
class AliexpressApi
{
	...
	public $gatewayUrl = "http://gw.api.alibaba.com/openapi/";
    
    public $redirectUri = "";
    
    public $sysQuery = 'param2/1/aliexpress.open/';
    ...
    public function exec() {
        ...
        $apiParams = $this->getMosaic($apiParams);
        try {
            $this->response = VHelper::http_post_json($requestUrl, $apiParams);
    ...
    public function getMosaic($apiParams){
      $parameter = '';
        if(!empty($apiParams)){
    ...
    public function getCodeUrl() {
       $params = array(
            ...
            'redirect_uri'  => $this->redirectUri.'AliexpressToken/GetToken',
            'site'          => 'aliexpress'
       );
    ...
    */
    public function setRedirectUri() {
        ...
        $host = '';
        $this->redirectUri = $host . '/services/aliexpress/';
