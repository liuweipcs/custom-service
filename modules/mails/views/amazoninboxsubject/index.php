    ...
    <div class="row">
        <div class="col-lg-12">
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'buttons' => [
                            ...
                            [
                                'text' => '回复',
                                'href' => Url::toRoute('/mails/amazonreply/createsubject'),
                                'queryParams' => 'id',
                                'htmlOptions' => [
                                    'class' => 'edit-record'
                                ],
                            ...
                            [
                                'text' => '移除标签',
                                'href' => Url::toRoute('/mails/amazoninboxsubject/removetags'),
                                'queryParams' => '{id}',
                                'htmlOptions' => [
                                    'class' => 'edit-record'
                                ],
                            ...
                            [
                                'text' => '移至客户来信',
                                'href' => Url::toRoute('/mails/amazoninboxsubject/moveclientletter'),
                                'queryParams' => '{id}',
                                'htmlOptions' => [
                                    'class' => 'delete-record',
                                    'confirm' => '确定要移至客户来信吗？',
                ...
                'toolBars' => [
                    [
                        'href' => Url::toRoute('/mails/amazoninboxsubject/batchmark'),
                        'text' => '批量标记为已回复',
                        'htmlOptions' => [
                            'class' => 'delete-button',
                            'data-src' => 'id',
                    ...
                    [
                        'href' => Url::toRoute('/mails/amazoninboxsubject/addtags'),
...
<script type="text/javascript">
        ...
        function () {
            document.onkeyup = function () {
                ...
                if (tag_id != '' && tag_id != 'undefined') {
                    ...
                    $.post('<?= Url::toRoute(['/mails/amazoninboxsubject/addtags', 'type' => 'list'])?>', {'MailTag[inbox_id]': ids, 'MailTag[tag_id][]': tag_id, 'MailTag[type]': 'list'}, function (data) {
                        if (data.code == "200")
    ...
    $(function (){
        $("#w0").attr('multiple', true);
    });

    $(function () {
        //amazon邮件提醒
        function amazonInboxMailNotify() {
            var amazon_mail_notify = $.cookie("amazon_mail_notify");
            if (amazon_mail_notify == "1") {
                return false;
            }
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo Url::toRoute(['/mails/amazoninboxsubject/getamazonmailnotify']); ?>",
                data: params,
                dataType: "json",
                global: false,
                success: function (data) {
                    if (data["code"] == 1) {
                        ...
                        for (var ix in data) {
                            ...
                            content += "    <p>主题：<a target='_blank' href='/mails/amazoninboxsubject/view?id=" + data[ix]["id"] + "'>" + data[ix]["now_subject"] + "</a></p>";
                            content += "    </div>";
                            content += "</div>";
                        }
                            ...
                            layer.open({
                                ...
                                cancel: function (index, layero) {
                                    layer.confirm('是否今天之内不再弹出提醒窗口？', {
                                        ...
                                        $.cookie("amazon_mail_notify", "1", {expires: leftTime, path: '/'});
                                        layer.close(index);
                                    }, function () {
                                    });
                                }
        ...
        setTimeout(amazonInboxMailNotify, 3000);
        setInterval(amazonInboxMailNotify, 30000);
        //导出excel
        $("#export-excel").on("click", function () {
            ...
            location.href = "<?php echo Url::toRoute('/mails/amazoninboxsubject/export'); ?>?" + queryStr;
            return false;
        });
    });
</script>