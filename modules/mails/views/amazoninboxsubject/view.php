                        ...
                        if (!empty($tags_data)) {
                            foreach ($tags_data as $key => $value) {
                                ...
                                <li style="margin-right: 20px;" class="btn btn-default"
                                    ...
                                    <span use_data="<?php echo $key; ?>"><?php echo $value; ?></span>&nbsp;
                                ...
                                <?php } else { ?>
                                    <div class="panel panel-primary reply_tit" id="content_<?php echo $model['id']; ?>"
                                                           ...
                                                           <?php } else { ?>
                                                            <li class="tag label btn-info md ion-close-circled">
                                                                <span style="cursor: pointer;" class="remark showAddRemark"
                                                                      data-id="<?php echo $model['id']; ?>"
                                                                      data1=""><?php echo \app\common\VHelper::break_string($model['remark'], 30); ?></span>
                                                                &nbsp;&nbsp;
                                        ...
                                        <div style="margin:1px 0;">
                                            ...
                                            <?php echo AmazonInbox::wherethrAttch($model->id, 0) ?>
                                            <?php $replied = AmazonInbox::getReplied($model['id']); ?>
                                        ...
                                        <?php if (!empty($model->body)) { ?>
                                            ...
                                            <div class="panel-body"
                                                ...
                                                <iframe src="<?php echo Yii::$app->request->getHostInfo() . Url::toRoute(['/mails/amazoninboxsubject/getinboxbody', 'id' => $model->id]); ?>"></iframe>
                                            </div>
                                        <?php } ?>
                                    </div>
                                <?php } ?>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>feedback<br/>退货编码<br/>售后<br/>仓库客诉</th>
                                    <th>Review</th>
                                    <th>包裹信息</th>
                                    <th>操作</th>
                                </tr>
                                ...
                                if (!empty($historica)) {
                                    ...
                                    foreach ($historica as $hKey => $order) {
                                        ...
                                        if (!empty($rela_order_name)) {
                                            if ($rela_is_arr) {
                                                foreach ($order['son_order_id'] as $son_order_id) {
                                                    $order_result .= '<p><a _width="100%" _height="100%" class="edit-button" href="/orders/order/orderdetails?platform=' . Platform::PLATFORM_CODE_AMAZON . '&system_order_id=' . $son_order_id . '" title="订单信息">
                                                            ' . $son_order_id . '</a></p>';
                                                }
                                        ...
                                        <tr class="active">
                                            ...
                                            <?php $account_info = \app\modules\accounts\models\Account::getHistoryAccountInfo($order['account_id'], AmazonInbox::PLATFORM_CODE); ?>
                                            <td>
                                                <?php
                                                ...
                                                if (!empty($order['profit'])) {
                                                    ...
                                                    if (!empty($order['after_sale_redirect'])) {
                                                        foreach ($order['after_sale_redirect'] as $after_sale_redirect) {
                                                            $cost = new Order;
                                                            $cost = $cost->getRedirectCostByOrderId(Platform::PLATFORM_CODE_AMAZON, $order['order_id']);
                                            ...
                                            <td>
                                                <input type="hidden" name="rating"
                                                       value="<?php echo isset($order['order_feedback']['rating']) ? $order['order_feedback']['rating'] : '' ?>">
                                                <input type="hidden" name="comments"
                                                       value="<?php echo isset($order['order_feedback']['comments']) ? $order['order_feedback']['comments'] : '' ?>">
                                                <!--                                            feedback-->
                                                <?php
                                                //
                                                if (!empty($order['order_feedback'])) {
                                                    echo '<span class="label label-danger feedback">有</span>';
                                                } else {
                                                ...
                                                if ($aftersaleinfo) {
                                                    ...
                                                    $res = AfterSalesOrder::getAfterSalesOrderByOrderId($order['order_id'], Platform::PLATFORM_CODE_EB);
                                                    if (!empty($res['domestic_return'])) {
                                                        $domestic_return = '退货跟进';
                                                        if ($res['domestic_return']['state'] == 1) {
                                                            $state = '未处理';
                                            ...
                                            <td>
                                                ...
                                                if (!empty($order['order_review'])) {
                                                    $siteList = \app\modules\accounts\models\Account::getSiteList('AMAZON');
                                                    $domainName = isset($siteList[$order['order_review']['accountId']]) ? 'https://' . $siteList[$order['order_review']['accountId']] : "";
                                                    if ($domainName) {
                                                        //https://www.amazon.de/gp/customer-reviews/R1BX1AGUCX8XDF/ref=cm_cr_dp_d_rvw_ttl?ie=UTF8&ASIN=B071PCWP5X
                                                        echo $html .= '<a href="' . $domainName . '/gp/customer-reviews/' . $order['order_review']['reviewId'] . '/?ie=UTF8&ASIN=' . $order['order_review']['asin'] . '" target="_blank">' . $order['order_review']['asin'] . '</a>';
                                                    } else {
                                                        echo $html .= $order['order_review']['asin'];
                                                    }
                                                } else {
                                                    echo '<span class="label label-success">无</span>';
                                                }
                                                ...
                                                if (count($historica[$hKey]['orderPackage'])) {
                                                    foreach ($historica[$hKey]['orderPackage'] as $k => $val) {
                                                        ...
                                                        if ($order['paytime'] < '2018-05-20 00:00:00') {
                                                            ...
                                                            echo!empty($trackNumber) ? '<a _width="100%" _height="100%" class="edit-button" href="' . Url::toRoute(['/orders/order/gettracknumber', 'track_number' => $trackNumber]) . '" title="查看物流跟踪信息">' . $trackNumber . '</a>' : '-' . '<br/>';
                                                        }
                                                        echo '</td>';
                                                    }
                                                } else {
    ...
    <div class="col col-md-6">
        <div class="panel panel-default">
            ...
            $form = ActiveForm::begin([
                        'id' => 'amazoninbox-form',
                        //'layout' => 'horizontal',
                        'action' => Url::toRoute(['/mails/amazonreply/createsubject', 'id' => $subject_model->id, 'next' => 1]),
            ...
            <div class="panel-body">
                ...
                <div class="panel panel-default" style="margin-bottom:15px;">
                    <div class="mail_template_area panel-body">
                        <?php
                        $mailTemplates = MailTemplate::getMailTemplateDataAsArrayByUserId(Platform::PLATFORM_CODE_AMAZON);
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <input type="file" id="" name="AmazonReply[file][]"
                    ...
                    <!--在鼠标移动位置插入参数-->
                    <div class="form_data" style="float: right;font-size: 12px;margin-right: -290px;">
                        <?php
                        $order_info = [];
                        if (!empty($historica)) {
                            foreach ($historica as $hKey => $order) {
                        ...
                        $asin = '';
                        if ($order_info) {
                            $buyer_id = $order_info['buyer_id'] ? $order_info['buyer_id'] : '';
                            $track_number = $order_info['track_number'] ? $order_info['track_number'] : '';
                            $title_a = [];
                            $asin_a = [];
                            if ($order_info['detail']) {
                                foreach ($order_info['detail'] as $k => $v) {
                                    $title_a[] = $v['title'] . '(item_number:' . $v['item_id'] . ')';
                                    $asin_a[] = $v['asinval'];
                                }
                        ...
                        <select id="countDataType" class="form-control"
                            ...
                            <option value="<?php echo $title; ?>">产品标题</option>
                            <option value="<?php echo $asin; ?>">ASIN</option>
                ...
                <div class="col-md-12 panel-body" style="padding-bottom: 100px;margin-left: -13px;">
                    ...
                    <?= Html::a('新增标签', Url::toRoute(['/mails/amazoninboxsubject/addtags', 'ids' => $subject_model->id, 'type' => 'detail']), ['class' => 'btn btn-sm btn-primary add-tags-button-button']) ?>

                    <?= Html::a('移除标签', Url::toRoute(['/mails/amazoninboxsubject/removetags', 'id' => $subject_model->id, 'type' => 'detail']), ['class' => 'btn btn-sm btn-danger add-tags-button-button']) ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">feedback详情</h4>
            </div>
            <div class="modal-body">
...
<script type="text/javascript">
    ...
    $('.reply_mail_mark').click(function () {
        ...
        //上一个 下一个
        if (markType == 'last') {
            window.location.href = "<?php echo Url::toRoute(['/mails/amazoninboxsubject/view?last=1']) ?>";
        } else if (markType == 'next') {
            window.location.href = "<?php echo Url::toRoute(['/mails/amazoninboxsubject/view?next=1']) ?>"
    ...
    var markSubjectStatus = function (id, stat) {
        $.get('<?= Url::toRoute("/mails/amazoninboxsubject/mark") ?>', {id: id, stat: stat}, function (data) {
    ...
    var markEmailStatus = function (id, stat) {
        $.get('<?= Url::toRoute("/mails/amazoninboxsubject/markemail") ?>', {id: id, stat: stat}, function (data) {
            var $data = $.parseJSON(data);
            if ($data.code == "200") {
    ...
    var go = function (obj) {
        ...
        $.post('<?= Url::toRoute("/mails/msgcontent/searchtemplate") ?>', {
            'name': search,
            'platform_code': '<?php echo Platform::PLATFORM_CODE_AMAZON; ?>'
        }, function (data) {
            if (data.status) {
                for (var i in data.content) {
                    if (j <= 12) {
    ...
    var dosubmit = function () {
        if (!$('.reply-sub').val()) {
            layer.alert('请填写回复主题！', {icon: 5});
            return false;
        } else if (!$('#amz-reply').val()) {
            layer.alert('请填写回复内容!', {icon: 5});
            return false;
        } else {
            $("#amazoninbox-form").submit();
        }
        return true;
    }
    ...
    function removetags(obj) {
        ...
        $.post('<?= Url::toRoute(['/mails/amazoninboxsubject/removetags', 'id' => $subject_model->id, 'type' => 'detail']) ?>', {
    ...
    $('.get-data-id').on('click', function () {
        ...
        $('#amazonreply-inbox_id').val(inbox_id);
    })
                ...
                document.onkeyup = function (e) {
                    ...
                    if (event.shiftKey && keyboards['shift'] != undefined && keyboards['shift'][event.keyCode] != undefined) {
                        ...
                        if (tag_id != '' && tag_id != undefined) {
                            $.post('<?= Url::toRoute(['/mails/amazoninboxsubject/addretags', 'ids' => $subject_model->id, 'type' => 'detail']) ?>', {
    ...
    function clikTrans(that, k) {
        ...
        $.get("<?php echo Url::toRoute(['/mails/amazoninboxsubject/getinboxtransbody']) ?>", {
            "id": k
        }, function (data) {
            if (data["code"] == 1) {
    ...
    $("#addRemarkBtn").on("click", function () {
        ...
        console.log(params);
        $.post("<?php echo Url::toRoute(['/mails/amazoninboxsubject/addremark']) ?>", params, function (data) {
            if (data["code"] == 1) {
                var data = data["data"];
    ...
    $("#page-wrapper-inbox").on("click", "a.clearRemarkBtn", function (e) {
        ...
        $.post("<?php echo Url::toRoute(['/mails/amazoninboxsubject/clearremark']) ?>", {
            "id": id
        }, function (data) {
            if (data["code"] == 1) {
    ...
    $(document).on('click', '.subject_remark', function () {
        ...
        layer.prompt({title: 'amazon邮件主题备注', value: remark, formType: 2}, function (text, index) {
            $.ajax({
                type: "POST",
                dataType: "JSON",
