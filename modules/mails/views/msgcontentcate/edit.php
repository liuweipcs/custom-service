...
<div class="popup-wrapper">
    ...
    <div class="popup-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <?php echo $form->field($model, 'parent_id')->dropdownList($categoryList, ['id' => 'category_id', 'encodeSpaces' => true]); ?>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <?php echo $form->field($model, 'status')->inline()->radioList([0 => '否', 1 => '是']); ?>
            </div>
        </div>
