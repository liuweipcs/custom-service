...
<div class="panel panel-default">
    <div class="panel-heading">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"><h4 class="panel-title">订单信息</h4></a>
    </div>
...
//                                        var_dump($detail);die;
                ...
                <?php if (Platform::PLATFORM_CODE_EB == 'EB') { ?>
                    <tr>
                        ...
                        <td>
                            <?php echo $info['info']['email']; ?>&nbsp;&nbsp;<a _width="95%" _height="95%"
                                                                                class="edit-button"
                    ...
                    <tr>
                        ...
                        <td colspan="4"><?php if (!empty($info['note'])) echo $info['note']['note'] ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><textarea style="width:300px;height:60px;" class="remark"></textarea>
                        ...
                        <td><textarea style="width:300px;height:60px;"
    ...
    function saveRemark(orderId) {
        ...
        $.post(url, {'order_id': orderId, 'remark': remark}, function (data) {
            if (data.ack != true)
                ...
                var info = data.info;
                var html = '<table class="table" style="margin-bottom: -10px;"><tbody>';
                for (var i in info) {
