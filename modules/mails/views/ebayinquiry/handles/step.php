<style>
    .stepInfo {position: relative;background: #f2f2f2;margin: 40px auto 0 auto;width: auto;}
    ...
    <div class="container" style="height:120px;width:100%;">
        <div class="stepInfo">
            ...
            <?php if(($k == 15 && !empty($ondeList[$k])) || ($k == 30 && !empty($ondeList[$k])) || ($k != 15 && $k != 30)){ ?>
                <div class="stepIco stepIco<?=$i;?>" <?php if(isset($ondeList[$k])  && ($k != 15 && $k != 30 && $info['payment_status'] == 1)){?>style="background: rgb(79, 182, 64) none repeat scroll 0px 0px;" <?php }?>  <?php if($k == 15 || $k == 30 || ($k == 5 && $info['payment_status'] != 1)){?> style="background: rgb(255,0,0) none repeat scroll 0px 0px;"<?php }?>>
                    <?php echo $i;?>
