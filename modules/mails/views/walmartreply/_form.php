...
$form = ActiveForm::begin([
    ...
    'layout' => 'horizontal',
    'action' => Url::toRoute(['/mails/walmartreply/create', 'id' => $model->inbox_id]),
...
<div class="popup-body">
    ...
    <?= $form->field($model, 'inbox_id', ['template' => '{input}', 'options' => ['style' => 'display:none;']])->hiddenInput() ?>
    <?= $form->field($model, 'reply_content')->textarea(['rows' => 6]) ?>
    <?= $form->field($model, 'is_draft')->dropDownList(['0' => '否', '1' => '是']) ?>
</div>
