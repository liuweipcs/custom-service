...
<div id="page-wrapper">
    ...
    $form = ActiveForm::begin([
        'id' => 'sendEmailForm',
        'action' => Url::toRoute(['/mails/cdiscountinboxsubject/sendemail']),
        'method' => 'post',
        ...
        <tr>
            ...
            <td>
                ...
                if (!empty($platformOrderId)) {
                    $order_info = OrderKefu::getOrderStack(Platform::PLATFORM_CODE_CDISCOUNT, $platformOrderId);
                    if (!empty($order_info)) {
        ...
        <tr>
            ...
            <td>
                ...
                $tagList = Tag::find()
                    ...
                    ->andWhere(['platform_code' => Platform::PLATFORM_CODE_CDISCOUNT, 'status' => 1])
