...
<div class="popup-wrapper">
    <style>
        ...
        #batchupdateMailoutbox td {
            border: 1px solid #ccc;
            padding: 10px;
        }

        #batchupdateMailoutbox td.col1 {
            width: 180px;
            text-align: right;
            font-weight: bold;
        }
    ...
    $form = ActiveForm::begin([
        'id' => 'batchupdateMailoutboxForm',
        'action' => Url::toRoute(['/mails/mailoutbox/batchupdate']),
        'method' => 'post',
    ]);
    ?>
    <div class="popup-body">
        <table id="batchupdateMailoutbox">
            <tr>
