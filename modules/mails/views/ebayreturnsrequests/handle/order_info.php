...
?>
<style>
    .cik{width: 63px; height: 22px;line-height: 22px;display: inherit;text-align: center;background: #00adff;color: #fff;cursor: pointer;border-radius: 12%;}
</style>
...
//                                        var_dump($detail);die;
                    ...
                    <?php if (Platform::PLATFORM_CODE_EB == 'EB'): ?>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><?php if (!empty($info['note'])) {
                                    echo $info['note']['note'];
                                } ?></td>
                        </tr>
                        <tr>
