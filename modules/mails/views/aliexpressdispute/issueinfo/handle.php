        ...
        <div class="col-md-7">
            <div class="col-md-12">
                <div class="panel-group" id="accordion">
                    ...
                    echo $this->render('order_info', ['info' => $info, 'countries' => $countries, 'isAuthority' => $isAuthority]);//订单信息
                    echo $this->render('product_detail', ['info' => $info, 'platform' => $platform]);//产品详情
