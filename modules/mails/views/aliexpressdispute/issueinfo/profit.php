            ...
            <table class="table table-striped">
                ...
                <?php if (!empty($info['profit'])) { ?>
                    ...
                    <tr>
                        ...
                        <td colspan="17" align="center" style="color: red"><?php echo $totalCost; ?>(CNY)&nbsp;备注:此处的成本/支出的平均成本为:平均采购成本+平均采购运费</td>
                        <td align="center">
                            <?php if ($final_profit) {
                                echo $final_profit >= 0 ? '<font color="green">' . $final_profit . '(CNY)</font>'
                                    : '<font color="red">' . $final_profit . '(CNY)</font>';
                            } else {
                                echo $info['profit']['profit'] >= 0 ? '<font color="green">' . $info['profit']['profit'] . '(CNY)</font>'
                                    : '<font color="red">' . $info['profit']['profit'] . '(CNY)</font>';
                            }
                            ?>
                            <!--        --><?php //echo $profit->profit >= 0 ? '<font color="green">' . $profit->profit . '(CNY)</font>'
                            //            : '<font color="red">' . $profit->profit . '(CNY)</font>';?>
                        </td>
                        <td align="center">
                            <?php if ($final_profit_rate) {
                                echo $final_profit_rate >= 0 ? '<font color="green">' . $final_profit_rate . '%</font>'
                                    : '<font color="red">' . $final_profit_rate . '%</font>';
                            } else {
                                echo $info['profit']['profit_rate'] >= 0 ? '<font color="green">' . $info['profit']['profit_rate'] . '%</font>'
                                    : '<font color="red">' . $info['profit']['profit_rate'] . '%</font>';
                            }
                            ?>
                            <!--        --><?php //echo $profit->profit_rate >= 0 ? '<font color="green">' . $profit->profit_rate . '%</font>'
                            //            : '<font color="red">' . $profit->profit_rate . '%</font>';?>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <?php if ($new_final_profit) {
                                echo $new_final_profit >= 0 ? '<font color="green">' . $new_final_profit . '(CNY)</font>'
                                    : '<font color="red">' . $new_final_profit . '(CNY)</font>';
                            } else {
                                echo $info['profit']['profit_new1'] >= 0 ? '<font color="green">' . $info['profit']['profit_new1'] . '(CNY)</font>'
                                    : '<font color="red">' . $info['profit']['profit_new1'] . '(CNY)</font>';
                            }
                            ?>
                        </td>
                        <td align="center">
                            <?php if ($new_final_profit_rate) {
                                echo $new_final_profit_rate >= 0 ? '<font color="green">' . $new_final_profit_rate . '%</font>'
                                    : '<font color="red">' . $new_final_profit_rate . '%</font>';
                            } else {
                                echo $info['profit']['profit_rate_new1'] >= 0 ? '<font color="green">' . $info['profit']['profit_rate_new1'] . '%</font>'
                                    : '<font color="red">' . $info['profit']['profit_rate_new1'] . '%</font>';
                            }
                            ?>
                ...
                <?php } else { ?>
                    <tr>
                        <td colspan="13" align="center">没有找到信息！</td>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
