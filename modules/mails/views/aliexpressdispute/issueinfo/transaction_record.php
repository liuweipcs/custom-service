        ...
        <div class="panel-body">
            <table class="table table-striped transactionRecord">
                ...
                if (!empty($info['trade'])) { ?>
                    ...
                    <tr>
                        <td colspan="8" align="center">没有找到信息！</td>
                    </tr>
    ...
    $(function () {
        $(".save").on('click', function () {
            ...
            $.ajax({
                ...
                data: {'account': account, 'transactionId': transactionNumber, 'currency': currency, 'amount': amount, 'order_id': '<?php echo !empty($info['info']['order_id']) ? $info['info']['order_id'] : ''; ?>'},
