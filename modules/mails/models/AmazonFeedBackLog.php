...
/**
 * This is the model class for table "amazon_feedback_log".
 *
 * @property integer $id
 ...
 */
class AmazonFeedBackLog extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return '{{%amazon_feedback_log}}';
    }
