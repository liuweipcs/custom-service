                                                                ...
                                                                <div class="col-sm-7">
                                                                    <select class="form-control" name="reason_code[<?php echo $item['item_id'];?>]">
                                                                        <?php foreach($reasonCodeList as $code => $reason_text){?>
                                                                            <option value="<?php echo $code;?>"<?php echo $item['reason_code'] == $code ? ' selected="selected"' : '';?>><?php echo $reason_text;?></option>
                                                                        <?php }?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <table class="table table-striped">
                                                            ...
                                                            <tr>
                                                                <td>Product</td>
                                                                <td><?php echo $item['item_price_amount']-$item['item_tax_amount']-$item['promotion_discount_amount'] . $item['item_currency_code'];?></td>
                                                                <td>0.00</td>
                                                                <td><input remain="<?php echo $item['item_price_amount']-$item['item_tax_amount']-$item['promotion_discount_amount'];?>" value="<?php echo $item['refund_item_price_amount'];?>" name="item_price_amount[<?php echo $item['item_id']?>]" class="form-control refund_item" size="4" type="text" /></td>
                                                                <td>MAX:<?php echo $item['item_price_amount']-$item['item_tax_amount']-$item['promotion_discount_amount'] . $item['item_currency_code'];?></td>
                                                            </tr>
                                                            <?php if (!empty($item['item_tax_amount']) && $item['item_tax_amount'] > 0) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td>0.00</td>
                                                                    <td><input remain="<?php echo $item['item_tax_amount'];?>" value="<?php echo $item['refund_item_tax_amount'];?>" name="item_tax_amount[<?php echo $item['item_id']?>]" class="form-control refund_item" size="4" type="text" /></td>
                                                            ...
                                                            <?php if (!empty($item['item_shipping_amount']) && $item['item_shipping_amount'] > 0) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td>0.00</td>
                                                                    <td><input remain="<?php echo $item['item_shipping_amount']-$item['shipping_tax_amount']-$item['shipping_discount_amount'];?>" value="<?php echo $item['refund_item_shipping_amount'];?>" name="item_shipping_amount[<?php echo $item['item_id']?>]" class="form-control refund_item" size="4" type="text" /></td>
                                                            ...
                                                            <?php if (!empty($item['shipping_tax_amount']) && $item['shipping_tax_amount'] > 0) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td>0.00</td>
                                                                    <td><input remain="<?php echo $item['shipping_tax_amount'];?>" value="<?php echo $item['refund_shipping_tax_amount'];?>" name="shipping_tax_amount[<?php echo $item['item_id']?>]" class="form-control refund_item" size="4" type="text" /></td>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-2">
                                                                    <div class="form-control" disabled="disabled"><?php echo $currencyCode;?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
