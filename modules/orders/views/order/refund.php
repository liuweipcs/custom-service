    ...
    <div class="popup-body">
        <form class="form-horizontal" role="form" id="refund_form">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                        <select class="form-control"  name="type" onchange="returnedType(this.value);">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" id="focusedInput" type="text"  name="express_num">
                </div>
            </div>
            <div class="form-group product_sum">
                <label class="col-sm-2 control-label"><span style="color: red">*</span>退款金额：</label>
                <div class="col-sm-10">
                    <input class="form-control" id="focusedInput" type="text" name="refund_sum" >
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                   ...
                   <select class="form-control" name="reason">
                       <?php if(!empty($reason)){?>
                         <?php foreach($reason as $reason_reason){?>
                            <option value="<?php echo $reason_reason['id'];?>"><?php echo $reason_reason['content'];?></option>
                         <?php }?>
                       <?php }?>
                    </select>
                </div>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <input type="hidden" value="<?php echo $system_order_id;?>" name="system_order_id"/>
