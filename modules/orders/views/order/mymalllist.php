        ...
        <div class="col-lg-12">
            <div class="well">
                <input type="hidden" name="platform_code"
                       value="<?php echo \app\modules\accounts\models\Platform::PLATFORM_CODE_MALL; ?>">
        ...
        <table class="table table-striped table-bordered">
            ...
            <?php if (!empty($orders)) { ?>
                <?php foreach ($orders as $item) {
                    $account_info = \app\modules\accounts\models\Account::getHistoryAccountInfo($item['account_id'], 'MALL');
                    ?>
                    <tr>
